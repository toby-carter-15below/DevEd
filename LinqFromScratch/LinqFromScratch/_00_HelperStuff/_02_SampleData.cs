...
namespace LinqFromScratch
{
    public static class SampleData
    {
        public static readonly Employee[] EmployeeList = new[] {
                ...
                new Employee(){EmployeeId = 2, DepartmentId = 3, Name = "David Lee Roth"},
                new Employee(){EmployeeId = 3, DepartmentId = 2, Name = "Alex Van Halen"},
        ...
        public static readonly Department[] DepartmentList = new[] {
                ...
                new Department()
                {
                    DepartmentId = 2,
                    ParentId = null,
                    Name = "Dept. of mind blowing percussion"
                },
                new Department()
                {
                    DepartmentId = 3,
